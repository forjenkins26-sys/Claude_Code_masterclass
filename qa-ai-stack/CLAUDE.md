...
This stack combines:
- **Our QA engine** — anti-hallucination (33 rules), auto-fix protocol (17 rules), agent-factory (RCA/Heal/Flaky), rule-engine, the 3 core skills
