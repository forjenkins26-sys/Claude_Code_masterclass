...
- Confirm CLAUDE.md, ANTI-HALLUCINATION-RULES.md (30 rules), AUTO-FIX-PROTOCOL.md (17 rules), knowledge-base/ in project root
...
| `ANTI-HALLUCINATION-RULES.md` | 30 rules preventing selector guessing, wrong assertions (Rule 25: KB bug-oracle + Confirmed/Suspected tiers) |
