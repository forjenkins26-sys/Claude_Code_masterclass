...
| **Epic** | **SCRUM-626** — Blinkit — Customer Login Quality Assurance (14 ACs) |
...
| 2 | `/test-case-creation SCRUM-626` | Requirements → test cases in Jira, edge-case matrix walked per control | ~4 min |
| 3 | `/test-case-execution SCRUM-626` | Headed run. **Failures classified before any fix.** Real bugs filed, test issues auto-fixed | ~5 min |
| 4 | `/test-closure SCRUM-626` | AC→test traceability, counted coverage, Go / No-Go verdict | ~2 min |

Optional 5th: `/requirement-drift SCRUM-626` — edit an AC in Jira mid-demo, then show it detecting the drift and scoping the re-test.
