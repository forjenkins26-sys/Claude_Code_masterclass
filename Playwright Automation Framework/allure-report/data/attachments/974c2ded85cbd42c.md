...
- Name: ui\registration.spec.ts >> Registration Page Tests (SCRUM-142) >> REG-020: Verify all-lowercase password is rejected [WILL FAIL — BUG-B]
- Location: tests\ui\registration.spec.ts:196:7
...
Call log:
  ...
  - waiting for locator('#passwordError')
    14 × locator resolved to <div class="error-msg" id="passwordError">Password does not meet all requirements</div>
