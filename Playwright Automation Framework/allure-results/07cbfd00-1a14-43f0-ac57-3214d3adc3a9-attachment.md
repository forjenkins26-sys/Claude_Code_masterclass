...
- Name: ui\registration.spec.ts >> Registration Page Tests (SCRUM-142) >> REG-011: Verify @ symbol only is rejected [WILL FAIL — BUG-A]
- Location: tests\ui\registration.spec.ts:110:7
...
Call log:
  ...
  - waiting for locator('#emailError')
    14 × locator resolved to <div id="emailError" class="error-msg">Enter a valid email address (e.g. name@domain.com)</div>
